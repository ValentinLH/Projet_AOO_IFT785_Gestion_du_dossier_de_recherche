...
public class FabriqueEtudiant extends FabriquePersonne {
    ...
    public Ressource createRessource(String nom, String prenom, int echelle, int echelon, float heuresHebdo, LocalDate debutContrat,
    		LocalDate finContrat, String cip, Programme programme) {
        return new Etudiant(nom, prenom, echelle, echelon, heuresHebdo, debutContrat, finContrat, cip, programme);
    }
