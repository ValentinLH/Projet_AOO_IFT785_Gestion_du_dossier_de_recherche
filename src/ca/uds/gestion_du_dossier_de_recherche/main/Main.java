...
public class Main {
	...
	public static void main_fabrique(String[] args) {
		System.out.println("Hey");
		FabriquePersonne factory = new FabriqueEtudiant();

		Ressource ressource = factory.createRessource("John", "Doe", 1, 1, 40.0f, LocalDate.of(2023, 1, 1),
	...
	public static void main(String[] args) {
		...
		view.getOkButton().addActionListener(e -> {
			...
			// Faire quelque chose avec l'employé, par exemple l'ajouter à une liste,
			// l'envoyer à une méthode, etc.
		});
	}
	...
	public static void main_test_factory(String[] args) {
		...
		// Ressource e = FabriqueEtudiant.fabricateurRessource("Nom", "Prenom", 10.0,
		// "DC", "FC", "cip", 0);
		// e.display();
