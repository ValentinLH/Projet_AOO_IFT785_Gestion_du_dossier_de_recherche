...
public class VentilationManagerTest {
    ...
    public void testVentilerMontants() {
        ...
        assertEquals(500.0, result.get(0).getThird(), 0.01); // Le montant attribué au premier projet pour la première ressource
        assertEquals(500.0, result.get(1).getThird(), 0.01); // Le montant attribué au deuxième projet pour la deuxième ressource
        assertEquals(1000.0, result.get(2).getThird(), 0.01); // Le montant attribué au deuxième projet pour la deuxième ressource
